...
void semanticAnalyzer(){
    ...
    int currSequence = 0;
    checkModule(astRoot->sc->rs->sc->rs->rs->rs, &currSequence);
    checkModule(astRoot->sc->rs->rs->sc->rs->rs->rs, &currSequence);
    checkModule(astRoot->sc->rs->rs->rs->sc->rs->rs->rs, &currSequence);
}
